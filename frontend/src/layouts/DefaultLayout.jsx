                        ...
                        <div className="hidden md:block">
                           <div className="ml-10 flex items-baseline space-x-4">
                              ...
                              <NavLink
                                 key={item.name}
                                 to={item.to}
                                 // REMEMBER THAT REACT HAS THIS BUILT INTO ROUTER. YOU CAN GET isActive FROM ANYWHERE INSIDE NavLink
                                 // AND USE IT TO CONDITIONALLY APPLY CLASSES BASED ON IF THE CURRENT ROUTE IS ACTIVE 
                                 // SEE https://reactrouter.com/en/main/components/nav-link
                                 // classnames() ON THE OTHER HAND IF JUST A FUNCTION DEFINED ABOVE
                        ...
                        <div className="ml-4 flex items-center md:ml-6">
                           ...
                           <Menu as="div" className="relative ml-3">
                              ...
                              <Menu.Items className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                                 <Menu.Item>
                                    {/* LOGOUT IS A FUNCTION THAT GETS AN EVENT AS AN ARGUMENT */}
                                    <a
                                       href='#'
